        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 mt-3 gap-5">
            <img
              src={store1}
              alt="store"
              className="md:col-span-4 w-full rounded-md shadow-xl aspect-video object-cover shadow-color1"
            />
            <div className="md:col-span-3 text-gray-500 font-medium">
              ...
              <div className="flex mt-5 bg-gray-50 rounded-lg py-2 px-3 md:w-[350px] shadow-lg opacity-80 ">
              ...
              {editPermission && (
                <Link
                  to="edit"
                  className="block text-center py-2 text-color2 mt-5 rounded bg-primary sm:w-[150px]"
                >
                  Edit Store
                </Link>
              )}
